...
struct evaluateAcceptance {
  ...
  void fillGenPairInfo(TLepton const& t1, TLepton const& t2, TMCParticles const& mcParticles)
  {
    ...
    int mother_id = FindSM(t1, t2, mcParticles);
  ...
  int FindSM(TTrack const& posmc, TTrack const& negmc, TMCParticles const& mcParticles)
  {
    int arr[] = {
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 111, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 221, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 331, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 113, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 223, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 333, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 443, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 100443, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 553, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 100553, mcParticles),
      FindCommonMotherFrom2Prongs(posmc, negmc, cfgPdgLepton, cfgPdgLepton, 200553, mcParticles)};
