...
DECLARE_SOA_TABLE(PhotonFilters, "AOD", "PhotonFilters", //!
                  filtering::PHOSPhoton, filtering::PHOSElectron, filtering::PHOSPair, filtering::PHOSnbar, filtering::PCMHighPtPhoton, filtering::PCMMatCalib, filtering::PCMEtaDalitz);
